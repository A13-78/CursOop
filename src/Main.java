...
Студенты Пуффендуя трудолюбивы, верны, честны. Когтевранцы умны, мудры, остроумны и полны творчества.
...
Гарри Поттер, Гермиона Грейнджер и Рон Уизли учатся на факультете Гриффиндор.  Драко Малфой, Грэхэм Монтегю, Грегори Гойл учатся на Слизерине.
На факультет Пуффендуй учатся Захария Смит, Седрик Диггори, Джастин Финч-Флетчли. На факультете Когтевран учится Чжоу Чанг, Падма Патил и Маркус Белби.
...
Сделайте метод, который выводит на экран описание студента. В описание надо включать качества, которые присущи всем студентам, плюс качества,
...
Тот ученик, у которого сумма свойств больше, считается лучшим учеником. Метод должен выводить в консоль сравнение учеников.
...
public class Main {
    public static void main(String[] args) {
        ...
        Slytherin severus = new Slytherin("Severus Snegg", 10, 15, 10, 30, 10, 15, 5);

        Hufflepuff zaharia = new Hufflepuff("Zaharia Smith",2,5,1,6,3);
        Hufflepuff crog = new Hufflepuff("Crog Sleep",3,5,2,6,5);

        Ravenclaw choy = new Ravenclaw("Choy Chang",4,2,6,3,1,6);
        Ravenclaw cong = new Ravenclaw("Cong Chang",4,2,6,3,1,6);

        Gryffindor germiona = new Gryffindor("Germiona Grenjer",5,5,5,5,6);
        Gryffindor harry = new Gryffindor("Harry Poter",7,8,10,16,10);
        Gryffindor ron = new Gryffindor("Ron Uizly",6,2,5,9,5);

        System.out.println(harry);
        harry.compareStudents(germiona);
        System.out.println(drako);
        drako.compareStudents(severus);
        System.out.println(zaharia);
        zaharia.compareStudents(crog);
        System.out.println(choy);
        cong.compareStudents(choy);
